"""Pytest conftest for the Chapter 20 test suite.

Adds the selected tree's ``ch20-mceliece/src`` to ``sys.path`` so the ``mceliece``
...
PACKAGE_SRC = REPO_ROOT / IMPL / "ch20-mceliece" / "src"
