"""Pytest conftest for the Chapter 25 test suite.

Adds the selected tree's ``ch25-cbom/src`` to ``sys.path`` so the ``cbom`` package
...
PACKAGE_SRC = REPO_ROOT / IMPL / "ch25-cbom" / "src"
