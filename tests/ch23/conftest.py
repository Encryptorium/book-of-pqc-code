"""Pytest conftest for the Chapter 23 test suite.

Adds the selected tree's ``ch23-sqisign/src`` to ``sys.path`` so the ``sqisign``
...
PACKAGE_SRC = REPO_ROOT / IMPL / "ch23-sqisign" / "src"
