"""Pytest conftest for the Chapter 19 test suite.

Adds the selected tree's ``ch19-coding-theory/src`` to ``sys.path`` so the ``coding_theory``
...
PACKAGE_SRC = REPO_ROOT / IMPL / "ch19-coding-theory" / "src"
