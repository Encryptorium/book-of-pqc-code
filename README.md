...
**Chapters released so far: Chapters 1 through 22, which is all of Part I, all of Part II, all of Part III, and the first four chapters of Part IV.** The rest of the book is in editorial review, and each chapter's trees land here on the day its prose publishes.
